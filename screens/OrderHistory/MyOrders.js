      ...
      <Header
        ...
        leftComponent={
          <IconButton
            ...
            icon={icons.back}
            iconStyle={{ width: 20, marginRight: 40, height: 20, tintColor: COLORS.black }}
      ...
      >
        ...
        <TextButton
          buttonContainerStyle={{
            flex: 1,
            height: SIZES.padding * 1,
            borderRadius: SIZES.radius,
            borderColor: COLORS.gray2,
            marginHorizontal: SIZES.radius,
            backgroundColor:
              selectedButton == 0 ? COLORS.primary : COLORS.white,
          }}
          label={"Open Orders"}
          labelStyle={{
            paddingHorizontal: SIZES.padding,
            color: selectedButton == 0 ? COLORS.black : COLORS.primary,
          }}
          onPress={() => {
            setSelectedButton(0);
          }}
        ...
        <TextButton
          buttonContainerStyle={{
            ...
            marginHorizontal: SIZES.radius,
            backgroundColor:
              selectedButton == 1 ? COLORS.primary : COLORS.white,
          }}
          label={"History"}
          labelStyle={{
            paddingHorizontal: SIZES.padding,
            color: selectedButton == 1 ? COLORS.black : COLORS.primary,
          }}
          onPress={() => {
            setSelectedButton(1);
          }}
